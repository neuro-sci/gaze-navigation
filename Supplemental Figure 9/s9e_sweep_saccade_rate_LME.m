function s9e_sweep_saccade_rate_LME(blocks)
%% Fit linear mixed models for trial-specific effects on sweep saccade rates
...
%% LME: trial-specific effects on saccade rate: forward premove

[fixed_forward_premove_rate,random_forward_premove_rate,R_vals_forward_premove_rate,P_vals_forward_premove_rate]=...
    linear_mixed_effects(blocks,rate_forward_premove,clrs.gold);
ylabel('Relative effect');

%% LME: trial-specific effects on saccade rate: backward premove

[fixed_backward_premove_rate,random_backward_premove_rate,R_vals_backward_premove_rate,P_vals_backward_premove_rate]=...
    linear_mixed_effects(blocks,rate_backward_premove,clrs.gold);
ylabel('Relative effect');

%% LME: trial-specific effects on saccade rate: forward move

[fixed_forward_move_rate,random_forward_move_rate,R_vals_forward_move_rate,P_vals_forward_move_rate]=...
    linear_mixed_effects(blocks,rate_forward_move,clrs.blue);
ylabel('Relative effect');

%% LME: trial-specific effects on saccade rate: backward move

[fixed_backward_move_rate,random_backward_move_rate,R_vals_backward_move_rate,P_vals_backward_move_rate]=...
    linear_mixed_effects(blocks,rate_backward_move,clrs.blue);
ylabel('Relative effect');
